import { Boxes, Facebook } from "lucide-react";
        ...
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2">
            ...
            <div className="mt-6 lg:max-w-sm">
              ...
              At Lalon Store, we offer a curated selection of high-quality products to meet all your lifestyle needs. From everyday essentials and trendy apparel to unique gifts and home décor, our dedicated team is committed to providing you with an exceptional shopping experience and complete satisfaction.
              </p>
            </div>
          </div>
