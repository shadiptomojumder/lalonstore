...
const ProductDetailsPage = () => {
    ...
    return (
        <main>
            <div className="container mx-auto my-13 px-3 sm:px-0">
                <section className="mb-15 flex flex-col items-start gap-10 sm:flex-row sm:gap-15 md:gap-25">
                    <div className="mx-auto rounded-sm border border-gray-200 bg-[#d7f2dc] p-0 shadow-lg sm:mx-0">
                        {product && (
                            <Image
                                ...
                                width={300}
                                height={300}
                                className="aspect-[412/312] h-full w-full rounded-sm object-cover"
                            />
                        )}
                    </div>
                    <div className="mx-auto rounded-lg bg-white text-center sm:mx-0 sm:text-start">
                        ...
                        <p className="text-2xl font-medium text-primary">৳ {product?.finalPrice}</p>
